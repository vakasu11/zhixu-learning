...
import { DATA_STRUCTURE_CHAPTERS } from "@/lib/data-structure-code/topic-catalog";
...
export type Course = {
  ...
  pale: string;
  current: string;
  chapters: { title: string; topics: string[]; source?: string }[];
...
export const COURSES: Course[] = [
  {
    ...
    chapters: DATA_STRUCTURE_CHAPTERS, quickQuestions: ["如何从操作计数推导时间复杂度？", "数组线性表和链式线性表该怎样选择？", "贪婪、动态规划、回溯和分支定界有什么区别？"],
  },
  {
